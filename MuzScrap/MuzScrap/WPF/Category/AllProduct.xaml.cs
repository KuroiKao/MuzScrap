...
namespace MuzScrap.WPF.Category
{
    ...
    public partial class AllProduct : Window
    {
        ...
        public ProductCard ProductCards { get; set; }

        public Product Products { get; set; }

        private readonly UserIdNow _userID = new(default);

        public AllProduct(UserIdNow userID)
        {
            InitializeComponent();
            _userID = userID;

            ListProduct.ItemsSource = MuzScrapBdContext.GetInstance().Products.ToList();
            TotalStrings.Text = MuzScrapBdContext.GetInstance().Products.Count().ToString();
        }
        private void SearchBox_KeyUp(object sender, System.Windows.Input.KeyEventArgs e)
        {
            var filtered = MuzScrapBdContext.GetInstance().Products.ToList().Where(search =>
                ...
                | search.ProductType.ToLower().Contains(SearchBox.Text.ToLower()));
        ...
        private void ListProduct_MouseDoubleClick(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            var list = db.Products.Where(x => (x.Store == "https://www.muztorg.ru" || x.Store == "https://jazz-shop.ru") && x.Title == selectedProduct.Title);
            foreach (var li in list)
            {
                ...
                if(li.Store == "https://www.muztorg.ru")
                {
                    productCard.Image = li.Image;
                    productCard.Price = li.Price.Trim();
                    productCard.Source = li.Source.Trim();
                    productCard.Store = li.Store.Trim();
                }
                if (li.Store == "https://jazz-shop.ru")
                {
                    productCard.Image2 = li.Image;
                    productCard.Price2 = li.Price.Trim();
                    productCard.Source2 = li.Source.Trim();
                    productCard.Store2 = li.Store.Trim();
                }
            }
            ...
            //        //{
            //        //    productCard.Image = "https://www.muztorg.ru/img/no_photo.png";
            //        //}
            //        //else
            //        //    productCard.Image = selectedProduct.Image.Trim();
            //        productCard.Image = selectedProduct.Image;
            ...
            //        //if (selectedProduct.Image == null)
            //        //{
            //        //    productCard.Image2 = "https://www.muztorg.ru/img/no_photo.png";
            //        //}
            //        //else
            //        //    productCard.Image2 = selectedProduct.Image.Trim();

            //        productCard.Image2 = selectedProduct.Image;
